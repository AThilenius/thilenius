...
int64_t CalculatorAsyncClient::sync_add(apache::thrift::RpcOptions& rpcOptions, int32_t num1, int32_t num2) {
  ...
  add(rpcOptions, std::move(callback0), num1, num2);
...
folly::Future<int64_t> CalculatorAsyncClient::future_add(apache::thrift::RpcOptions& rpcOptions, int32_t num1, int32_t num2) {
  ...
  std::unique_ptr<apache::thrift::RequestCallback> callback3(new apache::thrift::FutureCallback<int64_t>(std::move(promise1), recv_wrapped_add, channel_, (rpcOptions.getUseForReadHeaders() ? &rpcOptions : nullptr)));
